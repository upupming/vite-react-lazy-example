...
react_production_min.cloneElement = function(a, b, c) {
  ...
  if (b != null) {
    ...
    for (f2 in b)
      H$2.call(b, f2) && !I$2.hasOwnProperty(f2) && (e[f2] = b[f2] === void 0 && g2 !== void 0 ? g2[f2] : b[f2]);
  }
...
function Uc(a, b) {
  ...
  if (f2 !== 0)
    ...
    var k = f2 & ~g2;
    k !== 0 ? (d = Rc(k), e = F$1) : (h &= f2, h !== 0 && (d = Rc(h), e = F$1));
  } else
    f2 = c & ~g2, f2 !== 0 ? (d = Rc(f2), e = F$1) : h !== 0 && (d = Rc(h), e = F$1);
  if (d === 0)
    return 0;
  d = 31 - Vc(d);
  d = c & ((0 > d ? 0 : 1 << d) << 1) - 1;
...
function Gi(a, b, c) {
  ...
  switch (b.tag) {
    ...
    case 19:
      ...
      return d.tail !== null ? (c = d.tail, d.rendering = c, d.tail = c.sibling, d.lastEffect = b.lastEffect, d.renderingStartTime = O(), c.sibling = null, b = P.current, I$1(P, f2 ? b & 1 | 2 : b & 1), c) : null;
    case 23:
    case 24:
...
function createBrowserHistory(b) {
  ...
  function A2(c, a) {
    ...
    if (!g2.length || (g2.call({ action: l2, location: k, retry: f2 }), false)) {
  ...
  function y2(c, a) {
    ...
    g2.length && (g2.call({ action: l2, location: k, retry: f2 }), 1) || (k = [{ usr: k.state, key: k.key, idx: v2 }, e(k)], m2.replaceState(k[0], "", k[1]), z2(l2));
  }
  function w(c) {
    m2.go(c);
  }
...
export { BrowserRouter as B, Link as L, React as R, ReactDOM as a, Routes as b, Route as c, jsxRuntime as j, react as r };
